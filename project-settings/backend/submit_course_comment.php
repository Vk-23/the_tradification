...
// Basic validation
if (!$course_id || !$name || !$email || !$comment) {
...
$sql = "INSERT INTO course_comments (course_id, name, email, comment, profile_picture, status, created_at) VALUES (?, ?, ?, ?, ?, 'pending', NOW())";
...
$stmt->bind_param("issss", $course_id, $name, $email, $comment, $profile_picture_path);
